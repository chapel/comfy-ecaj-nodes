...
{
  "decision": "block",
  "reason": "[kspec-worktree-guard] BLOCKED: Dangerous git operation in .kspec worktree. This worktree contains active session data and must stay on kspec-meta. Operations like reset, rebase, stash, and clean can corrupt session files. Change to main repo first: cd /home/chapel/Projects/comfy-ecaj-nodes"
}
EOF
    exit 0
  fi
