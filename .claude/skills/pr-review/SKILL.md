...
Review a PR linked to a kspec task, verify quality gates, and merge. This skill runs in **subagent context** and focuses on getting the PR merged with proper quality verification.
...
This skill runs in **subagent context**:
- Runs sequentially (caller waits for completion)
